    ...
    <AppLayout :title="isEdit ? 'Modifier bien' : 'Nouveau bien'">
        <div style="max-width:640px;">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;">
                <h1 style="font-size:1.15rem;font-weight:700;">{{ isEdit ? 'Modifier le bien' : 'Nouveau bien locatif' }}</h1>
                <Link :href="route('app.location.assets.index')" style="color:#6B7280;font-size:0.82rem;text-decoration:none;">← Retour</Link>
            </div>
